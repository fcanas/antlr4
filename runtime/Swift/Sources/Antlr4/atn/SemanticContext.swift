...
public class SemanticContext: Hashable, CustomStringConvertible {
    ...
    public class Predicate: SemanticContext {
        ...
        public override func hash(into hasher: inout Hasher) {
            ruleIndex.hash(into: &hasher)
            predIndex.hash(into: &hasher)
            isCtxDependent.hash(into: &hasher)
        }
    ...
    public class OR: Operator {
        ...
        public override func hash(into hasher: inout Hasher) {
            NSStringFromClass(OR.self).hash(into: &hasher)
            opnds.hash(into: &hasher)
        }
